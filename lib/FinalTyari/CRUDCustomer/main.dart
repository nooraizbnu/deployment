...
import 'package:procollab_web/FinalTyari/CRUD/main.dart';
import 'package:procollab_web/FinalTyari/CRUDCustomer/page/addpage.dart';
...
class CustomerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: appTitle,
      home: CustomerHome(title: appTitle),
    );
  }
}

class CustomerHome extends StatelessWidget {
  const CustomerHome({super.key, required this.title});
