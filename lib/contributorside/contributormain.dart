      ...
      child: FutureBuilder<DocumentSnapshot>(
          ...
          builder: ((context, snapshot){
            if (snapshot.connectionState == ConnectionState.done) {
              ...
              //                             margin: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width*0.01, MediaQuery.of(context).size.height*0.13, 0, 0),
              //                             child: Positioned(
              //                               child: Text("AI Model Trainer", style: TextStyle(
              //                                 fontSize: MediaQuery.of(context).size.height*0.03,
              //                                 color: mainColor,
              //                                 fontWeight: FontWeight.w600,
              //                               ),),
              ...
              //                               top: 10,
              //                               left: 10,
              //                               child: Text("https://www.linkedin.com/john-doe", style: TextStyle(
              //                                 fontSize: MediaQuery.of(context).size.height*0.02,
              //                                 fontWeight: FontWeight.w600,
              //                                 color: mainColor,
              //                               ),),
              ...
              //                         fontWeight: FontWeight.w700,
              //                       ),),
              //                       Text("Email: johndoe@gmail.com", style: TextStyle(
              //                         fontSize: MediaQuery.of(context).size.height*0.025,
              //                         color: mainColor,
              //                         fontWeight: FontWeight.w500,
              //                       ),),
              //                       Text("From: Pakistan", style: TextStyle(
              //                         fontSize: MediaQuery.of(context).size.height*0.025,
              //                         color: mainColor,
              //                         fontWeight: FontWeight.w500,
              //                       ),),
              //                       Text("Member Since: 02-02-2002", style: TextStyle(
              //                         fontSize: MediaQuery.of(context).size.height*0.025,
              //                         color: mainColor,
              //                         fontWeight: FontWeight.w500,
              //                       ),),
              //                       Text("Projects Completed: 4", style: TextStyle(
              //                         fontSize: MediaQuery.of(context).size.height*0.025,
              //                         color: mainColor,
              //                         fontWeight: FontWeight.w500,
              //                       ),),
              //                       Text("Ongoing Projects: 2", style: TextStyle(
              //                         fontSize: MediaQuery.of(context).size.height*0.025,
              //                         color: mainColor,
              //                         fontWeight: FontWeight.w500,
              //                       ),),
